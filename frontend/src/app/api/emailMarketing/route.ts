...
const mockStrategies = [
  {
    ...
    generated_strategy: {
      ...
      next_steps: ["Send initial welcome email", "Follow up with product intro"],
      content_calendar: ["Day 1: Welcome", "Day 3: Product Tour", "Day 7: Offer"],
      segmentation_strategy: "Target users who signed up within 7 days.",
      success_metrics: ["Open rate", "Click-through rate"],
    },
    target_audience_profile: { description: "New subscribers in the last week" },
  },
];
