...
import { Eye, Edit, Trash2, Plus, Globe } from "lucide-react";
  ...
  if (loading) {
    return (
      <div className="text-center py-8">
        ...
        <p className="mt-2 text-gray-600">Loading your landing pages...</p>
      </div>
    );
  }
            ...
            <Card key={page.id} className="hover:shadow-md transition-shadow">
              <CardHeader>
                ...
                <div className="text-sm text-gray-500">
                  <p>Business: {page.business_name || "Not specified"}</p>
