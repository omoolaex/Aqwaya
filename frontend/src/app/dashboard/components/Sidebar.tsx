...
//         <div className="md:hidden flex items-center justify-between px-4 py-3 bg-white shadow-sm sticky top-0 z-50">
...
//                   <p className="text-xl font-bold text-gray-900">Aqwaya.ai</p>
