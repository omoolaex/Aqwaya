  ...
  return (
    <AuthGuard>
      <div className="flex justify-center items-center min-h-screen bg-gray-50 p-4">
        <div className="bg-white shadow-md rounded-xl w-full max-w-2xl p-6 sm:p-8">
          {/* Header */}
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select className="mt-1 w-full sm:w-1/2 border rounded-md px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
